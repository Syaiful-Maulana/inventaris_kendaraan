...
@section('content')
  ...
  <div class="main-content">
    <section class="section">
      ...
      <a href="{{ url('tambahServis')}}" type="button" class="btn btn-success mb-3 mt-3"><i class="fas fa-plus-square"></i> Tambah</a>
      <table class="table table-bordered" id="table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <th>{{ $item->Tanggal }}</th>
            <td>
                <a href="{{ url('editServis/' .$item->id)}}" type="button" class="btn btn-info">Edit</a>
