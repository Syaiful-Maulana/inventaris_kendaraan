                    ...
                    <form action="{{ url('addKendaraan')}}" method="POST">
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" name="NoKendaraan" class="form-control @error('NoKendaraan') is-invalid @enderror" >
                            @error('NoKendaraan')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                          </div>
                          <div class="form-group">
                            ...
                            <input type="number" name="NoBPKB" class="form-control @error('NoBPKB') is-invalid @enderror" >
                            @error('NoBPKB')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                          </div>
                          <div class="form-group">
                            ...
                            <input type="text" name="unitKerja" class="form-control @error('unitKerja') is-invalid @enderror" >
                            @error('unitKerja')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                          </div>
